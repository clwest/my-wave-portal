...
contract WavePortal {
    ...
    function wave(string memory _message, uint256 memory _allWaves) public {
        require(
        ...
        waves.push(Wave(msg.sender, _message, block.timestamp, _allWaves));
        ...
        emit NewWave(msg.sender, block.timestamp, _message, _allWaves);
    }
